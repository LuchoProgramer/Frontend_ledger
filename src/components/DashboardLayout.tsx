    ...
    const menuItems: MenuItem[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Formulario 104', href: '/reportes/formulario-104', icon: <Calculator className="w-4 h-4" />, allowedRoles: ['Administrador', 'Contador'] },
                { name: 'Retenciones Recibidas', href: '/retenciones-recibidas', icon: <Receipt className="w-4 h-4" />, allowedRoles: ['Administrador', 'Contador'] },

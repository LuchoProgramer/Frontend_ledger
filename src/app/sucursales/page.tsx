...
export default function SucursalesPage() {
  ...
  const handleEdit = (s: Sucursal) => {
    ...
    setFormData({
      ...
      mostrar_en_mapa: s.mostrar_en_mapa || false
    });
    setShowModal(true);
  };
                ...
                <tr key={s.id}>
                  ...
                  <td className="px-6 py-4 text-center">
                    {s.latitud && s.longitud ? (
                      <span title={`${s.latitud}, ${s.longitud}`} className="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded">
                        📍 Configurada
                      </span>
                    ) : (
          ...
          {sucursales.map(s => (
            <div key={s.id} className="bg-white shadow rounded-lg p-4 space-y-3">
              ...
              <div className="text-sm text-gray-700 space-y-1">
                ...
                {s.latitud && <p className="text-xs text-blue-600">📍 Ubicación configurada</p>}
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="mostrar_en_mapa" className="ml-2 block text-sm text-gray-900">
                        Mostrar en Mapa Público
                      </label>
                    </div>
                  </div>
